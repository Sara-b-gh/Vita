package com.example.vita.entities;
...
public class Medicament {
    ...
    public Medicament(int id_medicament, String nom, String description, String dosage,
    ...
    public Medicament(String nom, String description, String dosage,
                      String forme, double prix, int stock, String statut) {
        this.nom = nom;
        this.description = description;
        this.dosage = dosage;
